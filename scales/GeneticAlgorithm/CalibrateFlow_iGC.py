...
#################
# MB method
network_name = '/home/drieder/Documents/packings/packed_spheres/extracted_networks/'
prefix = '200_R4_segmented'
...
network = op.io.network_from_statoil(path=network_name, prefix=prefix)
